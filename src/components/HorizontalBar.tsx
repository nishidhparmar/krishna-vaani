...
const HorizontalBar: FC<HorizontalBarProps> = (props) => {
    ...
    return (
        <Container>
            <div className='rounded-lg my-8 bg-gradient-to-r from-[#19FFFB] via-[#3DFF9B] to-[#FFCD4C] py-[1px]'>
                <div className='bg-primary px-[1px] rounded-lg'>
                    <div className={cn('bg-gradient-to-r rounded-lg from-[#00a15626] to-[#c6ab2632]  text-white font-medium text-lg  py-10 px-5 md:px-20 relative overflow-hidden', className)}>
